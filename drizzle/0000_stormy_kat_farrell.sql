CREATE TYPE "public"."mission_status" AS ENUM('planned', 'completed', 'cancelled');--> statement-breakpoint
...
CREATE INDEX "missions_user_due_idx" ON "missions" USING btree ("user_id","due_at");